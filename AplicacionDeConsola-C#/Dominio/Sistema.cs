    ...
    public class Sistema
    {
        ...
        private void PrecargarJugadores()
        {
            try
            {
                ...
                AltaJugador(new Jugador(326, "NDF", "Ernest Faber", DateTime.Parse("1971-08-27"), 1.84, "derecho", 1, "EUR", GetPais("Países Bajos"), "Defensa central"));
                ...
                AltaJugador(new Jugador(526, "NDF", "Luca Koleosho", DateTime.Parse("2004-09-15"), 0, "derecho", 1, "EUR", GetPais("Canadá"), "Extremo izquierdo"));
                ...
                AltaJugador(new Jugador(570, "NDF", "Alfred Gomis", DateTime.Parse("1993-09-05"), 1.96, "derecho", 35000000, "EUR", GetPais("Senegal"), "Portero"));
                ...
                AltaJugador(new Jugador(792, "NDF", "Oliver Denham", DateTime.Parse("2002-05-04"), 1.82, "derecho", 1, "EUR", GetPais("Gales"), "Defensa central"));
        ...
        #region Precarga Partidos
        private void PrecargarPartidos()
        {
            try
            {
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Argentina"), BuscarSeleccionPorNombrePais("Ecuador"), DateTime.Parse("2022-11-21 21:00:00"), Grupo.A));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Argentina"), BuscarSeleccionPorNombrePais("Senegal"), DateTime.Parse("2022-11-25 21:00:00"), Grupo.A));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Países Bajos"), BuscarSeleccionPorNombrePais("Argentina"), DateTime.Parse("2022-11-29 19:00:00"), Grupo.A));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Países Bajos"), BuscarSeleccionPorNombrePais("Ecuador"), DateTime.Parse("2022-11-25 21:00:00"), Grupo.A));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Ecuador"), BuscarSeleccionPorNombrePais("Senegal"), DateTime.Parse("2022-11-29 19:00:00"), Grupo.A));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Senegal"), BuscarSeleccionPorNombrePais("Países Bajos"), DateTime.Parse("2022-11-21 21:00:00"), Grupo.A));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Inglaterra"), BuscarSeleccionPorNombrePais("Irán"), DateTime.Parse("2022-11-21 19:00:00"), Grupo.B));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Inglaterra"), BuscarSeleccionPorNombrePais("Estados Unidos"), DateTime.Parse("2022-11-25 21:00:00"), Grupo.B));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Gales"), BuscarSeleccionPorNombrePais("Inglaterra"), DateTime.Parse("2022-11-29 19:00:00"), Grupo.B));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Gales"), BuscarSeleccionPorNombrePais("Irán"), DateTime.Parse("2022-11-25 19:00:00"), Grupo.B));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Irán"), BuscarSeleccionPorNombrePais("Estados Unidos"), DateTime.Parse("2022-11-29 21:00:00"), Grupo.B));
                AltaPartido(new FaseDeGrupos(BuscarSeleccionPorNombrePais("Estados Unidos"), BuscarSeleccionPorNombrePais("Gales"), DateTime.Parse("2022-11-21 19:00:00"), Grupo.B));
                AltaPartido(new FaseEliminatoria(BuscarSeleccionPorNombrePais("Argentina"), BuscarSeleccionPorNombrePais("Estados Unidos"), DateTime.Parse("2022-12-03 21:00:00"), Etapa.Octavos, true, false));
                AltaPartido(new FaseEliminatoria(BuscarSeleccionPorNombrePais("Inglaterra"), BuscarSeleccionPorNombrePais("Países Bajos"), DateTime.Parse("2022-12-03 19:00:00"), Etapa.Octavos, true, true));
                AltaPartido(new FaseEliminatoria(BuscarSeleccionPorNombrePais("Estados Unidos"), BuscarSeleccionPorNombrePais("Inglaterra"), DateTime.Parse("2022-12-08 19:00:00"), Etapa.Cuartos, false, false));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        #region Precarga Incidencias
        private void PrecargarIncidencias()
        {
            try
            {
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(9), 60), BuscarPartidoPorID(1));
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(1), 40), BuscarPartidoPorID(1));
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(4), 60), BuscarPartidoPorID(2));
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(570), 45), BuscarPartidoPorID(2));
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(5), 20), BuscarPartidoPorID(3));
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(455), 70), BuscarPartidoPorID(4));
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(456), 10), BuscarPartidoPorID(5));
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(572), 90), BuscarPartidoPorID(6));
                AltaIncidencia(new Incidencia("Tarjeta roja", BuscarJugadorPorId(268), 70), BuscarPartidoPorID(9));

                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(10), 60), BuscarPartidoPorID(1));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(2), 40), BuscarPartidoPorID(1));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(7), 60), BuscarPartidoPorID(2));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(571), 45), BuscarPartidoPorID(2));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(6), 28), BuscarPartidoPorID(3));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(458), 60), BuscarPartidoPorID(4));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(459), 63), BuscarPartidoPorID(5));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(573), 90), BuscarPartidoPorID(6));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(267), 80), BuscarPartidoPorID(7));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(270), 70), BuscarPartidoPorID(8));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(266), 60), BuscarPartidoPorID(9));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(793), 50), BuscarPartidoPorID(10));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(765), 40), BuscarPartidoPorID(11));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(772), 30), BuscarPartidoPorID(12));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(775), 20), BuscarPartidoPorID(13));
                AltaIncidencia(new Incidencia("Tarjeta amarilla", BuscarJugadorPorId(268), 10), BuscarPartidoPorID(14));


                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(7), 65), BuscarPartidoPorID(1));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(7), 70), BuscarPartidoPorID(1));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(6), 15), BuscarPartidoPorID(2));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(572), 65), BuscarPartidoPorID(2));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(5), 90), BuscarPartidoPorID(2));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(8), 50), BuscarPartidoPorID(3));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(2), 89), BuscarPartidoPorID(3));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(2), 91), BuscarPartidoPorID(3));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(323), 35), BuscarPartidoPorID(4));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(325), 65), BuscarPartidoPorID(4));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(460), 5), BuscarPartidoPorID(5));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(322), 65), BuscarPartidoPorID(6));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(267), 65), BuscarPartidoPorID(7));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(267), 85), BuscarPartidoPorID(7));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(267), 45), BuscarPartidoPorID(8));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(267), 35), BuscarPartidoPorID(9));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(267), 75), BuscarPartidoPorID(9));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(763), 35), BuscarPartidoPorID(11));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(769), 35), BuscarPartidoPorID(12));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(766), 115), BuscarPartidoPorID(13));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(322), 105), BuscarPartidoPorID(14));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(267), 119), BuscarPartidoPorID(14));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(267), -1), BuscarPartidoPorID(14));
                AltaIncidencia(new Incidencia("Gol", BuscarJugadorPorId(267), 89), BuscarPartidoPorID(15));
            }
            catch (Exception e)
            {
        ...
        #region Precarga Periodistas
        private void PrecargarPeriodistas()
        {
            try
            {
                AltaPeriodista(new Periodista("VictorHugo", "victor@gmail.com", "23167845"));
                AltaPeriodista(new Periodista("JulioHernandez", "julio@gmail.com", "12356748"));
                AltaPeriodista(new Periodista("YuririaSierra", "yi@gmail.com", "45623781"));
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public void AltaPais(Pais p)
        {
            try
            {
                if (p == null) throw new Exception("El pais no puede ser nulo");
                p.Validar();
                _paises.Add(p);
            }
            catch (Exception ex)
        ...
        public void AltaJugador(Jugador j)
        {
            try
            {
                if (j == null) throw new Exception("El jugador no puede ser nulo");
                j.Validar();
                _jugadores.Add(j);
            }
            catch (Exception e)
        ...
        public void AltaSeleccion(Seleccion s)
        {
            try
            {
                if (s == null) throw new Exception("La selección no puede ser nula");
                s.Validar();
                _selecciones.Add(s);
            }
            catch (Exception e)
        ...
        public void AltaPartido(Partido p)
        {
            try
            {
                if (p == null) throw new Exception("El partido no puede ser nulo");
                p.Validar();
                _partidos.Add(p);
            }
            catch (Exception e)
        ...
        public void AltaPeriodista(Periodista p)
        {
            try
            {
                if (p == null) throw new Exception("El periodista no puede ser nulo");
                p.Validar();
                if (BuscarPeriodistaPorEmail(p.Email) != null) throw new Exception("Ya existe un periodista con ese email");
                _periodistas.Add(p);
            }
            catch (Exception e)
            {
        ...
        public void AltaIncidencia(Incidencia i, Partido p)
        {
            try
            {
                if (i == null) throw new Exception("La incidencia no puede ser nula");
                if (p == null) throw new Exception("El partido no puede ser nulo");
                
                p.AgregarIncidenciaAPartido(i);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public Jugador BuscarJugadorPorId(int id)
        {
            ...
            int i = 0;
            while (buscado == null && i < _jugadores.Count)
            {
                if (_jugadores[i].Id.Equals(id)) buscado = _jugadores[i];
                i++;
            }
            return buscado;
        }
        ...
        public Periodista BuscarPeriodistaPorEmail(string email)
        {
            Periodista buscado = null;
            int i = 0;
            while (buscado == null && i < _periodistas.Count)
            {
                if (_periodistas[i].Email.Equals(email)) buscado = _periodistas[i];
                i++;
            }
        ...
        //Devuelve la seleccion del jugador
        public Seleccion BuscarSeleccionPorJugador(Jugador j)
        {
            Seleccion buscada = null;
            int i = 0;
            while (buscada == null && i < _selecciones.Count)
            {
                if (_selecciones[i].BuscarJugadorEnUnaSeleccion(j)) buscada = _selecciones[i];
                i++;
            }
            return buscada;
        }

        //Devuelve Todos los partidos de la selecion
        public List<Partido> BuscarPartidosPorSeleccion(Seleccion s)
        {
            List<Partido> aux = new List<Partido>();
            foreach (Partido p in _partidos)
            {
                if (p.Seleccion1 == s || p.Seleccion2 == s) aux.Add(p);
            }

            return aux;
        }
        //Devuelve todos lo partidos del jugador
        public List<Partido> BuscarPartidosPorJugador(int id)
        {
            return BuscarPartidosPorSeleccion(BuscarSeleccionPorJugador(BuscarJugadorPorId(id)));
        }

        public Seleccion BuscarSeleccionPorNombrePais(string pais)
        {
            Seleccion buscada = null;
            int i = 0;
            while (buscada == null && i < _selecciones.Count)
            {
                if (_selecciones[i].Pais.Nombre.ToUpper() == pais.ToUpper()) buscada = _selecciones[i];
                i++;
            }
            return buscada;
        }
        ...
        public void CambiarMontoBase(double valor)
        {
            Jugador.CambiarMontoBaseJugador(valor);
        }

       
        public List<Jugador> ListaDeJugadoresQueHanSidoExpulsadosAlMenosUnaVez()
        {
            List<Jugador> lista = new List<Jugador>();

            foreach (Partido p in _partidos)
            {
                //busca en las incidencias con tajeta roja en un partido y devuelve los jugadores sin repetir
                List<Jugador> listaEnUnPartido = p.ListarJugadorConTarjetaRojaEnUnPartido();

                foreach (Jugador j in listaEnUnPartido)
                {
                    //controla que no se repitan y los agreaga
                    if (!lista.Contains(j)) lista.Add(j); 

                }
            }

            lista.Sort(new OrdenarJugadorPorValorMercadoYNombre());
            return lista;
        }

        //En base a una seleccion, retorna el partido en que haya participado y hubo mas goles
        public List<Partido> PartidoConMasGolesEnQueParticipoUnaSeleccion(Seleccion s)
        {
            List<Partido> PartidosConMasGoles = new List<Partido>();
            int maxCantGoles = 0;
            foreach (Partido p in _partidos)
            {
                if (p.Seleccion1 == s || p.Seleccion2 == s)
                {
                    if (p.CalcularGolesDeUnPartido() > maxCantGoles)
                    {   
                        //Si el partido tiene mas goles que el ultimo maximo guardado
                        //Se actualiza el maximo, se limpia la lista y se agrega ese partido
                        maxCantGoles = p.CalcularGolesDeUnPartido();
                        PartidosConMasGoles.Clear();
                        PartidosConMasGoles.Add(p);
                    }
                    //si tienen los mismos goles tambien se agreaga
                    else if (p.CalcularGolesDeUnPartido() == maxCantGoles)
                    {
                        PartidosConMasGoles.Add(p);
                    }
                }                
